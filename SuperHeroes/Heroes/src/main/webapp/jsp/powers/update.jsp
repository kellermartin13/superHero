    ...
    <body>
        <div class="container col-md-12">
            ...
            <div class="container">
                <h1>Update Power</h1>
                <hr/>
                <h3>Update ${power.name}</h3>
                <p>Did your powers get cooler or lamer? Even if you lean
                    toward villainy, I hope the answer is cooler.</p>
            </div>
            <sf:form class="form-horizontal" role="form" modelAttribute="power" 
                     action="${pageContext.request.contextPath}/powers/update" method="POST">
