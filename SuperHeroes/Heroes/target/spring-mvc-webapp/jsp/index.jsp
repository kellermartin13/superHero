    ...
    <body>
        <div class="container col-md-12">
            ...
            <div class='col-md-offset-3 col-md-6'>
                <p>Holy Superhero, Batman! The Supers are out like never before,
                    fighting and creating crime all over the world. Given this 
                    exciting and unprecedented development, the Hero Education 
                    and Relationship Organization (HERO) built a one-stop-shop 
                    for everything Super. Keep a sharp eye out there - you 
                    never know when you'll encounter your next Super Sighting!</p>
            </div>
            <h2 class='col-md-12'>Recent Sightings From Around the World!</h2>
                    ...
                    <c:forEach var="sighting" items="${sightings}">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <c:out value="${sighting.location.country}"/>
                                </td>
                            </tr>
                        </tbody>
                    </c:forEach>
