...
<html>
    ...
    <body>
        <div class="container col-md-12">
            ...
            <div class="container">
                <form action="${pageContext.request.contextPath}/addNewOrg" method="POST">
                    <div class="form-group col-md-offset-4 col-md-4">
                        ...
                        <input type="text" class="form-control" 
                               ...
                               placeholder="New Organization Here"/>

                        <label for="description">Short Description:</label><br/>
                        <input type="text-area-lg" class="form-control" 
                               name="description" id="description" 
                               placeholder="Tell us about your organization!"/>


                        <div class="form-group">
                            <label for="heroes">Who is in the Organization?*</label>
                        ...
                        <button type="submit" class="btn btn-default col-md-offset-4">Add Organization</button>
                    </div>
                </form>
            </div>
