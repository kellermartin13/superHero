    ...
    <body>
        <div class="container col-md-12">
            ...
            <div class="container">
                ...
                <hr/>
                <h3>Update ${org.name}</h3>
            </div>
            <sf:form class="form-horizontal" role="form" modelAttribute="org" 
                     action="${pageContext.request.contextPath}/orgs/update" method="POST">
                ...
                <div class="form-group">
                    <label for="editMembers" class="col-md-4 control-label">Current Members:</label>
                    <div class="col-md-8">
                        <sf:checkboxes items="memberList" path="heroes"/>
                    </div>
