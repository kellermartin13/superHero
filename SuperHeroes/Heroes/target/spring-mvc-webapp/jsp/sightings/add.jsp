...
<html>
    ...
    <body>
        <div class="container col-md-12">
            ...
            <h1>Add Sighting</h1>
            <div class="container">
                <form action="${pageContext.request.contextPath}/sightings/confirmAdd" method="POST">
                    <div class="form-group col-md-offset-4 col-md-4">
                        ...
                        <div class="form-group">
                            <label for="hero">Who did you see?*</label>
                            <br/>
                            <select multiple class="form-control" name="heroId">
                        ...
                        <div class='form-group'>
                            <label for="country">Where did this happen?<br/>Country:</label>
                            <br/>
                            ...
                            <label for="locDesc">Short Location Description:</label>
                            <input type="text" class="form-control" id="locDesc" name="locDesc"/>
                        </div>
                        <button type="submit" class="btn btn-default">Add Sighting</button>
                    </div>
                </form>
            </div>
